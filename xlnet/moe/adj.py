...
####
# args.model_path = 'output_squad_bert_tiny/pytorch_model.bin'
# args.res_path = 'output_squad_bert_tiny/split/'
# args.templates = 'bert.encoder.layer.{}.intermediate.dense.weight'
args.model_path = '../output_squad_xlnet_large/pytorch_model.bin'
args.res_path = '../output_squad_xlnet_large/split/'
args.templates = 'transformer.layer.{}.ff.layer_1.weight'
####
...
def run(proc_id):
    ...
    for layer in range(num_layer):
        ...
        hidden = torch.cat(hidden, 0).reshape(-1, 1024) ####
